...
const itemNamesLoader = {
     ...
     */
    async load (cookie, repeatLoad = false, reloadItemNamesTimeout = 0) {
        ...
        try {
            ...
            const response = await get(
                'https://old.cs.money/js/database-skins/library-en-570.js',
                null,
                cookie,
            );
            ...
            console.log('Ошибка при получении списка названий предметов Dota 2', error);
        } finally {
            startReload();
        }
    },
